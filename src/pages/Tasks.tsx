...
const Tasks = () => {
  ...
  const getJobsForClientAndType = (clientId: string, jobType: string) => {
    return mockJobs.filter(job => job.clientId === clientId && job.type === jobType);
  };
      ...
      <div className="space-y-6">
        ...
        <div className="overflow-x-auto">
          <div className="min-w-max">
            {/* Header Row */}
            <div className="grid grid-cols-[200px_repeat(var(--client-count),_300px)] gap-4 mb-4" style={{'--client-count': mockClients.length} as any}>
            ...
            {jobTypes.map(jobType => (
              <div key={jobType} className="grid grid-cols-[200px_repeat(var(--client-count),_300px)] gap-4 mb-4" style={{'--client-count': mockClients.length} as any}>
                {/* Job Type Label */}
                            ...
                            {jobs.map(job => (
                              <div key={job.id} className="border rounded-lg p-3 bg-gray-50">
                                ...
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  {isOverdue(job.dueDate) && job.status !== 'completed' && job.status !== 'delivered' && (
